...
{ /* Function scope starts here */
  ...
  { /* New block scope starts here... */
    ...
    count1 = ::count1 + 3;   // This sets inner count1 to global count1+3  ==> 1002
    ++::count1;              // This changes global count1                 ==> 1002+999 or 999 or 1998 or 1005 or 2004
    // count1 = count1 + 1  // 1000
    count3 += count2;        // Increments outer count3 by inner count2;
    // count3 = count3 + count2; 
    std::cout << "\nValue of inner count1 = " << count1 << std::endl;
    std::cout << "Value of global count1 = "  << ::count1 << std::endl;
    std::cout << "Value of inner count3 = "  << count3 << std::endl;
